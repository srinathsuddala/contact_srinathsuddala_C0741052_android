...
import com.example.contact_srinathsuddala_c0741052_android.common.Utility;
...
public class UpdateContact extends AppCompatActivity {
    EditText fName,lName,phone,email,address;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        address = findViewById(R.id.editAddressUpdate);
